...
//        initialiser l'intent pour la detection de tag
    ...
    public void processNfcIntent(Intent intent) {
        try {
            ...
            System.out.println("_____message "+messageDansTag);
            //traitement des informations dans le tag
//            utilisation de TagAsync
//            TagAsync tagAsync = new TagAsync();
//            tagAsync.context = this.getBaseContext();
//            tagAsync.tagActivity = this;
//            Integer[] params = new Integer[]{new Integer(messageDansTag)};
//            tagAsync.execute(params);
